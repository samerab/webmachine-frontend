...
export * from './sal-common/sal-common.module';
export * from './sal-menu/menu.module';
export * from './sal-permission/sal-permission.module';
export * from './sal-translate/sal-translate.module';
export * from './directives/sam-directive.module';
export * from './pipes/sal-pipe.module';
export * from './sal-page/sal-page.module';
export * from './sal-file/sal-file.module';
...
export * from './sal-translate/language.service';
export * from './sal-translate/translate-obj';
export * from './sal-permission/permission.service';
export * from './sal-menu/services/menu.service';
export * from './sal-page/services/page.service';
export * from './sal-common/event.service';
